class Decorators:
    class WrapperAssignments:
        WRAPPER_ASSIGNMENTS = ['__doc__', '__name__', '__module__', '__annotations__']
    ...
    def class_wraps(cls):
        ...
        class Wrapper(cls):
            ...
            def __init__(self, wrapped, assigned=Decorators.WrapperAssignments.WRAPPER_ASSIGNMENTS):
